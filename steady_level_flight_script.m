% Author: Adam Frewin October 2018
% Description: Calculates values relevant aircraft performance in steady
% level flight, plots max glide coeff. vs airspeed, required thrust vs
% airspeed
...
W = 73000; % weight
S = 950; % wing area
Cd0 = 0.015; % Constant drag coefficient
